           ...
           $.get('dataToTable',function(responseJson) {
        	   if(responseJson!=null){
	               ...
	               $.each(responseJson, function(key,value) { 
	                       ...
	                       rowNew.children().eq(0).text(value['todayNews']); 
...
<%
	...
	session.setAttribute("viewMode", "news");
%>
<h4>Please Click below to get Latest News -</h4>
<input type="button" value="Show News" id="showTable"/>
<br/>
<br/>
